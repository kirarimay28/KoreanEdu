...
import { upsertEducationAnswer, getMyEducationAnswer, getEducationAnswersForWeek } from '../../store';
...
export default function EducationAnswerPage({ mode, onBack, currentUser }: Props) {
  ...
  const [answers] = useState<EducationAnswer[]>(() => getEducationAnswersForWeek(weekKey));
