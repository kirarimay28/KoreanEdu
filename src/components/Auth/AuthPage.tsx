...
export default function AuthPage({ onLogin }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Body */}
        <ellipse cx="155" cy="140" rx="48" ry="15" transform="rotate(-8 155 140)" fill="rgba(222,78,128,0.9)"/>
        {/* Tail feathers */}
        <path d="M110 148 C88 156 68 164 50 174" stroke="rgba(222,78,128,1)" strokeWidth="3.5" strokeLinecap="round"/>
        <path d="M113 153 C92 157 72 160 56 163" stroke="rgba(222,78,128,0.8)" strokeWidth="3" strokeLinecap="round"/>
        <path d="M116 157 C98 159 80 157 66 154" stroke="rgba(222,78,128,0.65)" strokeWidth="2.5" strokeLinecap="round"/>
        {/* Neck */}
        <path d="M196 128 C202 110 206 92 208 76" stroke="rgba(222,78,128,1)" strokeWidth="5.5" strokeLinecap="round"/>
        {/* Head */}
        <ellipse cx="210" cy="69" rx="11" ry="9" fill="rgba(222,78,128,0.95)"/>
        {/* Red crown */}
        <ellipse cx="211" cy="61" rx="5.5" ry="3.2" fill="rgba(155,55,48,0.85)"/>
        {/* Eye */}
        <circle cx="215" cy="70" r="2.2" fill="rgba(222,78,128,1)"/>
        {/* Beak */}
        <path d="M219 68 L236 63" stroke="rgba(222,78,128,1)" strokeWidth="2.5" strokeLinecap="round"/>
        {/* Upper wing */}
        <path d="M112 145 C122 105 150 80 196 128" fill="rgba(222,78,128,0.55)"/>
        ...
        {/* Upper wing edge */}
        <path d="M112 145 C124 102 152 78 196 128" stroke="rgba(222,78,128,1)" strokeWidth="1.2" fill="none"/>
        {/* Lower wing */}
        <path d="M112 148 C130 172 164 174 196 152" fill="rgba(222,78,128,0.35)"/>
        <path d="M112 148 C132 174 166 176 196 152" stroke="rgba(222,78,128,0.8)" strokeWidth="1" fill="none"/>
        {/* Legs */}
        <path d="M148 157 L142 192" stroke="rgba(222,78,128,0.9)" strokeWidth="2.5" strokeLinecap="round"/>
        <path d="M163 159 L158 194" stroke="rgba(222,78,128,0.9)" strokeWidth="2.5" strokeLinecap="round"/>
        {/* Feet */}
        <path d="M142 192 L134 198 M142 192 L142 200 M142 192 L150 198"
          stroke="rgba(222,78,128,0.85)" strokeWidth="1.5" strokeLinecap="round"/>
      ...
      >
        <path d="M22 72 Q32 48 52 54 Q56 32 80 34 Q104 28 108 50 Q126 40 138 56 Q156 48 162 66 L22 66Z"
          fill="rgba(222,78,128,0.9)" stroke="rgba(222,78,128,1)" strokeWidth="1"/>
        <path d="M14 80 Q28 60 46 64 Q50 50 66 52 Q80 48 84 62 Q96 58 102 70 L14 70Z"
          fill="rgba(222,78,128,0.55)" stroke="rgba(222,78,128,0.8)" strokeWidth="0.8"/>
        <path d="M150 76 Q160 62 172 66 Q174 56 186 58 Q196 54 198 66 L150 68Z"
          fill="rgba(222,78,128,0.4)" stroke="rgba(222,78,128,0.65)" strokeWidth="0.7"/>
      </svg>
      ...
      >
        <path d="M12 44 Q20 26 36 30 Q38 14 56 16 Q72 12 76 28 Q90 22 96 36 L12 38Z"
          fill="rgba(222,78,128,0.9)" stroke="rgba(222,78,128,1)" strokeWidth="0.8"/>
      </svg>
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="text-center mb-10">
          <div
            ...
            style={{
              ...
              boxShadow: '0 10px 40px rgba(222,78,128,0.22), 0 0 0 1px rgba(255,255,255,0.45) inset',
            }}
          >
            <BookOpen className="w-10 h-10" style={{ color: '#7e0e36', opacity: 0.80 }} />
          </div>
        ...
        {mode === 'select' && (
          <div className="rounded-3xl p-7" style={{ background: 'rgba(255,255,255,0.65)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.70)', boxShadow: '0 4px 24px rgba(222,78,128,0.10), 0 0 0 1px rgba(255,255,255,0.50) inset' }}>
